$(document).on('pageshow', '#favorites-page', function () {
    ...
    for (var indice = 0; indice < 5; indice++) {
        ...
        var newsItem = '<li data-icon="false">' + '<a href="news-detail.html" class="news-itemlist">' +
            ...
            '<h2>' + title + '</h2><p>' +
            abstract + '</p></a></li>';
        $("#favorites-feed").append(newsItem);
    }
    $('#favorites-feed').listview('refresh');
});